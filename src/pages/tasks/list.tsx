...
const List = ({ children }: React.PropsWithChildren) => {
  ...
  const handleOnDragEnd = (event: DragEndEvent) => {
    ...
    const taskId = event.active.id as string; //id of the task being dragged
    const taskStageId = event.active.data.current?.stageId; //stageId of the task being dragged
